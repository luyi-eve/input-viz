...
👉 Then, users will be able to check if their guesses are right or not by clicking the county map below. The correct number of each county will pop up for review.
